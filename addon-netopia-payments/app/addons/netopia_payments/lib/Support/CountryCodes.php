...
/**
 * ISO 3166-1 alpha-2 → numeric country code mapping.
 *
...
final class CountryCodes
{
    ...
    public const int DEFAULT_CODE = 642;
    ...
    public static function toNumeric(string $alpha2): int
    {
        return self::MAP[strtoupper($alpha2)] ?? self::DEFAULT_CODE;
    }
}
